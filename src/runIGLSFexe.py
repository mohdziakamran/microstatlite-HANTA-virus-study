...
def runIGLSFapp(accetionCode:str):
    ...
    # geneinputfile:str=r"C:\Users\User\OneDrive\Desktop\gitrepo\gene_data\Gene_File_"+accetionCode+".xlsx"
    # ssrinputfile:str=r"C:\Users\User\OneDrive\Desktop\gitrepo\ssr_data\SSR_File_"+accetionCode+".xlsx"

    pid = subprocess.Popen(["IGLSF.exe"]).pid
    app=Application().connect(process=pid,timeout=60)
    myapp=app.IGLSF.wait('visible')
